  ...
  return (
    <section
      ...
      <div className="flex-1 w-full mx-auto">
        {/* Logo & Description */}
        <div className="flex items-center justify-around gap-5 p-4 text-lg font-bold sm:text-2xl">
          <p className="font-mono text-center text-slate-200">
            مصنع السعادة أي بيتزا يرحب بكم...زورونا في جميع ولايات السلطنة
          </p>
          <img
            src={"/logo.png"}
            alt="Logo"
        ...
        <div className="flex flex-col justify-between w-full border-t md:flex-row">
          ...
          <div className="flex flex-col items-center px-4 py-8">
            ...
            <Link
              ...
              <MapPin />
              <p className="rounded-lg ">Al Khuwair - الخوير</p>
            </Link>
            ...
            <Link
              ...
              className="flex items-center gap-2 p-2 transition-colors duration-300 rounded-lg text-nowrap hover:text-orange-400">
              <MapPin />
              <p className="rounded-lg ">AL Amrat - العامرات</p>
            </Link>
            ...
            <Link
              ...
              className="flex items-center gap-2 p-2 transition-colors duration-300 rounded-lg text-nowrap hover:text-orange-400">
              <MapPin />
              <p className="rounded-lg ">Al-Watiya - الوطية</p>
            </Link>
            ...
            <Link
              ...
              className="flex items-center gap-2 p-2 transition-colors duration-300 rounded-lg text-nowrap hover:text-orange-400">
              <MapPin />
              <p className="rounded-lg ">Al Khawd - الخوض</p>
            </Link>
