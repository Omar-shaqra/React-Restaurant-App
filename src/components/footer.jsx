        ...
        <div className="flex flex-col justify-between w-full border-t md:flex-row">
          ...
          <div className="flex flex-col items-center px-4 py-8">
            ...
            <div className="flex items-center gap-3 p-2 mt-3 rounded-lg">
              <Phone />
              <p className="font-mono text-nowrap">+96878781278</p>
            </div>
            <div className="flex items-center gap-3 p-2 mt-3 rounded-lg">
              <Phone />
              <p className="font-mono text-nowrap">+96897310806</p>
            </div>
            {/* Socials */}
            <div className="flex items-center gap-3 p-2 mt-6 rounded-lg">
              <Link to={"https://www.instagram.com/apizza_om/"}>
              ...
              <Link to={"https://snapchat.com/t/diNqG2Xs"}>
                <svg
