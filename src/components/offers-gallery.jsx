...
const OffersGallery = () => {
  return (
    <section
      id="offers"
      className="flex flex-col items-start border-t-2 py-8 px-3 border-t-red-300 bg-gradient-to-tl from-[#fce7bb]/60 to-[#c6b796]/20 rounded-md">
      <h1
        className="pb-1 px-3 font-semibold
       text-2xl font-mono">
        Great offers🌟
      </h1>
